...
package com.alpha.voiceAssistant.edu;
...
public class VoiceAssistant {
    ...
    public void startSpeechRecognition() {
        ...
        while ((result = recognizer.getResult()) != null) {
            ...
            if (command.equalsIgnoreCase("Wake Up")) {
                active=true;
                System.out.println("Hi Boss , I am ready to help");
                speak("Hi Boss , I am ready to help");
            } else if(command.equalsIgnoreCase("Sleep")) {
                active=false;
                System.out.println("I am sleepy! Bye Boss");
                speak("I am sleepy! Bye Boss");
            }
    ...
    public void greetings() {
        System.out.println("Good Morning. How can i help sir?");
        speak("Good Morning. How can i help sir?");
    }
